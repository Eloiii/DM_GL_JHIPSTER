      ...
      <table class="table table-striped" aria-describedby="restaurants">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('coopcycleApp.restaurant.name')">Name</span></th>
            <th scope="row"><span v-text="$t('coopcycleApp.restaurant.address')">Address</span></th>
            <th scope="row"><span v-text="$t('coopcycleApp.restaurant.phone')">Phone</span></th>
            <th scope="row"><span v-text="$t('coopcycleApp.restaurant.email')">Email</span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
