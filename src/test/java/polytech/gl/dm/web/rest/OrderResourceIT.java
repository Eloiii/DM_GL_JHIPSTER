...
import polytech.gl.dm.repository.OrderRepository;
...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().address(DEFAULT_ADDRESS).price(DEFAULT_PRICE).status(DEFAULT_STATUS);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().address(UPDATED_ADDRESS).price(UPDATED_PRICE).status(UPDATED_STATUS);
        return order;
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.address(UPDATED_ADDRESS).price(UPDATED_PRICE).status(UPDATED_STATUS);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.address(UPDATED_ADDRESS).status(UPDATED_STATUS);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.address(UPDATED_ADDRESS).price(UPDATED_PRICE).status(UPDATED_STATUS);
