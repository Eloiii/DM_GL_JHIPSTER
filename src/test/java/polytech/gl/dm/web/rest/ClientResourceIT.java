...
import polytech.gl.dm.repository.ClientRepository;
...
class ClientResourceIT {
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).phone(UPDATED_PHONE).address(UPDATED_ADDRESS);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).phone(UPDATED_PHONE).address(UPDATED_ADDRESS);
