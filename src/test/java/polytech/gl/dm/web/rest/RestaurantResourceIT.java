...
import polytech.gl.dm.repository.RestaurantRepository;
...
class RestaurantResourceIT {
    ...
    public static Restaurant createEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().name(DEFAULT_NAME).address(DEFAULT_ADDRESS).phone(DEFAULT_PHONE).email(DEFAULT_EMAIL);
        return restaurant;
    }
    ...
    public static Restaurant createUpdatedEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().name(UPDATED_NAME).address(UPDATED_ADDRESS).phone(UPDATED_PHONE).email(UPDATED_EMAIL);
        return restaurant;
    }
    ...
    void putExistingRestaurant() throws Exception {
        ...
        updatedRestaurant.name(UPDATED_NAME).address(UPDATED_ADDRESS).phone(UPDATED_PHONE).email(UPDATED_EMAIL);
    ...
    void fullUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.name(UPDATED_NAME).address(UPDATED_ADDRESS).phone(UPDATED_PHONE).email(UPDATED_EMAIL);
